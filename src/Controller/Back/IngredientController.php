...
class IngredientController extends AbstractController
{
    ...
    #[Route('/ingredients', name: 'admin_ingredients_index', methods: ['GET'])]
    ...
    #[Route('/ingredients/new', name: 'admin_ingredients_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/ingredients/{id}', name: 'admin_ingredients_view', methods: ['GET'])]
    ...
    #[Route('/ingredients/{id}/edit', name: 'admin_ingredients_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/ingredients/{id}', name: 'admin_ingredients_delete', methods: ['POST'])]
