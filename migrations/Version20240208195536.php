 ...
 */
final class Version20240208195536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, picture VARCHAR(2083) DEFAULT NULL, description VARCHAR(255) NOT NULL, instructions LONGTEXT NOT NULL, difficulty VARCHAR(30) NOT NULL, preparation_time SMALLINT NOT NULL, cooking_time SMALLINT NOT NULL, servings SMALLINT NOT NULL, rating SMALLINT DEFAULT NULL, status SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, text VARCHAR(1500) NOT NULL, rating SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(150) NOT NULL, pseudo VARCHAR(30) NOT NULL, password VARCHAR(150) NOT NULL, email VARCHAR(255) NOT NULL, role VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
